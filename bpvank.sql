...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`bpvank` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
(1,1,'admin','Bpvank免费开源博客项目《版权声明》',6,'其他','本项目归Bpvank所有，禁止转载售卖，仅供学习使用，如您是从第三方途径付费购买的此项目欢迎检举，请第一时间联系邮箱：478292420@qq.com，谢谢配合！','','<h1 style=\"text-align: center;\">版权声明</h1><p>本项目归<strong>Bpvank</strong>所有，禁止转载售卖，仅供学习使用，如您是从第三方途径付费购买的此项目欢迎检举，请第一时间联系邮箱：478292420@qq.com，谢谢配合！</p><hr/><p>本资源来自Bpvank个人免费分享</p><p>哔哩哔哩账号：Bpvank<span style=\"font-size: 12px;\">（UID：3461580106762769）</span></p><p>网站地址：www.bpvank.com</p><p>微信公众号：Bpvank</p>','2022-11-03 10:10:46',1,2,1,2,0),
...
(1,'backstageHome','后台首页','Bpvank - 后台首页','/backstageHome','House',0,1),
(2,'articleOperation','文章操作','Bpvank - 文章操作','/articleOperation','Reading',0,1),
(3,'addArticle','新建文章','Bpvank - 新建文章','/addArticle','EditPen',2,1),
(4,'articleManager','文章管理','Bpvank - 文章管理','/articleManager','Edit',2,1),
(5,'classifyManager','分类管理','Bpvank - 分类管理','/classifyManager','FolderOpened',2,0),
(6,'commentManager','评论管理','Bpvank - 评论管理','/commentManager','ChatDotSquare',0,1),
(7,'userManager','用户管理','Bpvank - 用户管理','/userManager','MagicStick',0,0),
(8,'linkManager','链接管理','Bpvank - 链接管理','/linkManager','Link',0,0),
(9,'personSetup','个人设置','Bpvank - 个人设置','/personSetup','User',0,1),
(10,'systemSetup','系统设置','Bpvank - 系统设置','/systemSetup','Setting',0,0);
